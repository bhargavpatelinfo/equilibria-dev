...
const HeroSection: React.FC<HeroSectionType> = (block) => {
  ...
  return (
    <section
      id={id}
      className="mt-[120px] sm:mt-[150px] mb-[50px] lg:mb-[100px] xl:mb-[160px]"
    >
                  ...
                  return (
                    item?.label && (
                      <div key={index} className="w-full em:w-auto">
                        <Button
                          block={item}
                          className="!px-6 lg:!px-4 xl:!px-6 1xl:!px-10 !text-base xl:!text-lg "
                        />
                      </div>
                    )
                  );
          ...
          {image && (
            <div className="">
              <Image
                alt={image?.alt}
                src={image}
                className="w-full max-w-full md:max-w-[588px] h-[280px] sm:h-[350px] md:h-[661px] lg:h-full object-cover"
              />
            </div>
          )}
        </div>

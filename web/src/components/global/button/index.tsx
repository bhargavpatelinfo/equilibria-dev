...
export const buttonVariants: Record<ButtonVariantType, string> = {
  darkPink:
    ...
    transparentWithPink:"py-3 sm:py-4 px-6 sm:px-10 bg-transparent rounded-[60px] text-darkPink text-base sm:text-lg tracking-[-2%] border border-darkPink hover:bg-darkPink basic-transition hover:text-white hover:border-darkPink block text-center w-full em:w-fit",

    transparentWithWhite:"py-3 sm:py-4 px-6 sm:px-10 bg-transparent rounded-[60px] text-white text-base sm:text-lg tracking-[-2%] border border-white hover:bg-lightPink basic-transition hover:text-maroon hover:border-lightPink block text-center w-full em:w-fi"
};
